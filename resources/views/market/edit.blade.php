...
<div class="row">
    <div class="well">
        ...
        {!! Form::model($item, ['route' => ['postEditItem', $item->slug], 'method' => 'patch', 'role' => 'form', 'class' => 'form-horizontal']) !!}
            ...
            {!! Form::submit('Save changes', ['class' => 'btn btn-md btn-primary', 'id' => 'registerbutton']) !!}
